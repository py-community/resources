...
var n=echarts.init(document.getElementById("pladies_heat_map"),a);n.setOption({tooltip:{trigger:"item",formatter:function(a){var b=(a.value+"").split(".");return b=b[0].replace(/(\d{1,3})(?=(?:\d{3})+(?!\d))/g,"$1,"),a.seriesName+"<br/>"+a.name+" : "+b}},toolbox:{show:!0,orient:"vertical",x:"right",y:"center",feature:{mark:{show:!0},dataView:{show:!1,title:"Text View",lang:["Text View","Close","Refresh"],readOnly:!1},restore:{show:!1,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},dataRange:{show:!1,min:0,max:1,color:["#ff94e7","#FFFFFF"]},series:[{name:"PyLadies Groups ",type:"map",mapType:"world",roam:!0,scaleLimit:{min:1.28},mapLocation:{y:50},itemStyle:{emphasis:{label:{show:!0}}}, data:JSON.parse(dat2)
}]})
}); // d3.csv call
