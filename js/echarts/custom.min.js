...
var n=echarts.init(document.getElementById("pyladies_heat_map"),a);n.setOption({title:{text:"PyLadies Chapters Globally",subtext:"Data from Meetup.com"}, tooltip:{trigger:"item",formatter:function(a){var b=(a.value+"").split(".");return b=b[0].replace(/(\d{1,3})(?=(?:\d{3})+(?!\d))/g,"$1,"),a.seriesName+"<br/>"+a.name+" : "+b}},toolbox:{show:!0,orient:"vertical",x:"right",y:"center",feature:{mark:{show:!0},dataView:{show:!0,title:"Text View",lang:["Text View","Close","Refresh"],readOnly:!1},restore:{show:!1,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},dataRange:{min:0,max:30,calculable:!0,color:["#ee264d","#edaab7","#FFFFFF"]},series:[{name:"PyLadies Groups ",type:"map",mapType:"world",roam:!0,scaleLimit:{min:1.15},itemStyle:{emphasis:{label:{show:!0}}}, data:JSON.parse(dat2)
}]})
}); // d3.csv call
