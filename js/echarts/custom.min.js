...
var fus1=echarts.init(document.getElementById("pyladies_top_us_dest"),a);fus1.setOption({title:{text:"US/Canada",subtext:"Top 20 Cities"},color:["#ba1f1f"],tooltip:{trigger:"axis"},calculable:!0,xAxis:[{type:"value"}],yAxis:[{type:"category",boundaryGap:!0, axisLabel:{ interval:0 }, data:uscity.reverse()  }],grid: { left: 100 },
...
var feu=echarts.init(document.getElementById("pyladies_top_eu_dest"),a);feu.setOption({title:{text:"Europe",subtext:"Top 20 Cities"},color:["#ba1f1f"],tooltip:{trigger:"axis"},calculable:!0,xAxis:[{type:"value"}],yAxis:[{type:"category",boundaryGap:!0, axisLabel:{ interval:0 }, data:eucity.reverse()  }],grid: { left: 100 },
series:[{name:"Number of PyLadies",type:"bar",smooth:!1, barWidth:7,itemStyle:{}, data:eumembers.reverse()   }]})
...
var flat=echarts.init(document.getElementById("pyladies_top_latam_dest"),a);flat.setOption({title:{text:"Latin America",subtext:"Top 10 Cities"},color:["#ba1f1f"],tooltip:{trigger:"axis"},calculable:!0,xAxis:[{type:"value"}],yAxis:[{type:"category",boundaryGap:!0, axisLabel:{ interval:0 }, data:latamcity.reverse()  }],grid: { left: 100 },
...
var fasia=echarts.init(document.getElementById("pyladies_top_asia_dest"),a);fasia.setOption({title:{text:"Asia",subtext:"Top 5 Cities"},color:["#ba1f1f"],tooltip:{trigger:"axis"},calculable:!0,xAxis:[{type:"value"}],yAxis:[{type:"category",boundaryGap:!0, axisLabel:{ interval:0 }, data:asiacity.reverse()  }],grid: { left: 100 },
series:[{name:"Number of PyLadies",type:"bar",smooth:!1, barWidth:35,itemStyle:{}, data:asiamembers.reverse()   }]})
...
var faus=echarts.init(document.getElementById("pyladies_top_aus_dest"),a);faus.setOption({title:{text:"Australia",subtext:"Top 3  Cities"},color:["#ba1f1f"],tooltip:{trigger:"axis"},calculable:!0,xAxis:[{type:"value"}],yAxis:[{type:"category",boundaryGap:!0, axisLabel:{ interval:0 }, data:auscity.reverse()  }],grid: { left: 100 },
...
var fafr=echarts.init(document.getElementById("pyladies_top_afr_dest"),a);fafr.setOption({title:{text:"Africa",subtext:"Top 2  Cities"},color:["#ba1f1f"],tooltip:{trigger:"axis"},calculable:!0,xAxis:[{type:"value"}],yAxis:[{type:"category",boundaryGap:!0, axisLabel:{ interval:0 }, data:afrcity.reverse()  }],grid: { left: 100 },
